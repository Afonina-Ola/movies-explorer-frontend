    ...
    <header className="header">
      ...
      {!isLogged ? (
        <div className="header__container-not-logged">
          <NavLink
            to="/signup"
            className="header__not-logged-link-registration"
          >
            Регистрация
          </NavLink>
          <NavLink to="/signin" className="header__not-logged-link-entrance">
            Войти
          </NavLink>
        </div>
      ) : (
